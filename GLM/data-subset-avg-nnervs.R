...
data <- who_nrevss(region = "state", years = NULL)

prior_1516_who <- data["combined_prior_to_2015_16"]
prior_1516_who <- as.data.frame(prior_1516_who)
write.table(prior_1516_who, file = "prior_1516_who.tsv", row.names = FALSE, sep = "\t")

pubhealth_who <- data["public_health_labs"]
pubhealth_who <- as.data.frame(pubhealth_who)
write.table(pubhealth_who, file = "pubhealth_who.tsv", row.names = FALSE, sep = "\t")


clinical_who <- data["clinical_labs"]
clinical_who <- as.data.frame(clinical_who)
write.table(clinical_who, file = "clinical_who.tsv", row.names = FALSE, sep = "\t")
...
who_data$datedec <- decimal_date(as.Date(who_data$week_start))
...
who_data_NE <- who_data[who_data$region.stateili %in% census_regions_NE,]
who_data_NE_2019 <- who_data_NE %>% filter(between(datedec,2019.66,	2020.33))
NE_2019_mean <- colMeans(who_data_NE_2019[7])
...
who_data_MW <- who_data[who_data$region.stateili %in% census_regions_MW,]
who_data_MW_2019 <- who_data_MW %>% filter(between(datedec,2019.66,	2020.33))
MW_2019_mean <- colMeans(who_data_MW_2019[7])
...
who_data_S <- who_data[who_data$region.stateili %in% census_regions_S,]
who_data_S_2019 <- who_data_S %>% filter(between(datedec,2019.66,	2020.33))
S_2019_mean <- colMeans(who_data_S_2019[7])
...
who_data_W <- who_data[who_data$region.stateili %in% census_regions_W,]
who_data_W_2019 <- who_data_W %>% filter(between(datedec,2019.66,	2020.33))
W_2019_mean <- colMeans(who_data_W_2019[7])
...
who_data_ENC <- who_data[who_data$region.stateili %in% census_divisions_ENC,]
who_data_ENC_2019 <- who_data_ENC %>% filter(between(datedec,2019.66,	2020.33))
ENC_2019_mean <- colMeans(who_data_ENC_2019[7])
...
who_data_ESC <- who_data[who_data$region.stateili %in% census_divisions_ESC,]
who_data_ESC_2019 <- who_data_ESC %>% filter(between(datedec,2019.66,	2020.33))
ESC_2019_mean <- colMeans(who_data_ESC_2019[7])
...
who_data_MA <- who_data[who_data$region.stateili %in% census_divisions_MA,]
who_data_MA_2019 <- who_data_MA %>% filter(between(datedec,2019.66,	2020.33))
MA_2019_mean <- colMeans(who_data_MA_2019[7])
...
who_data_MNT <- who_data[who_data$region.stateili %in% census_divisions_MNT,]
who_data_MNT_2019 <- who_data_MNT %>% filter(between(datedec,2019.66,	2020.33))
MNT_2019_mean <- colMeans(who_data_MNT_2019[7])
...
who_data_NEdiv <- who_data[who_data$region.stateili %in% census_divisions_NEdiv,]
who_data_NEdiv_2019 <- who_data_NEdiv %>% filter(between(datedec,2019.66,	2020.33))
NEdiv_2019_mean <- colMeans(who_data_NEdiv_2019[7])
...
who_data_P <- who_data[who_data$region.stateili %in% census_divisions_P,]
who_data_P_2019 <- who_data_P %>% filter(between(datedec,2019.66,	2020.33))
P_2019_mean <- colMeans(who_data_P_2019[7])
...
who_data_SA <- who_data[who_data$region.stateili %in% census_divisions_SA,]
who_data_SA_2019 <- who_data_SA %>% filter(between(datedec,2019.66,	2020.33))
SA_2019_mean <- colMeans(who_data_SA_2019[7])
...
who_data_WNC <- who_data[who_data$region.stateili %in% census_divisions_WNC,]
who_data_WNC_2019 <- who_data_WNC %>% filter(between(datedec,2019.66,	2020.33))
WNC_2019_mean <- colMeans(who_data_WNC_2019[7])
...
who_data_WSC <- who_data[who_data$region.stateili %in% census_divisions_WSC,]
who_data_WSC_2019 <- who_data_WSC %>% filter(between(datedec,2019.66,	2020.33))
WSC_2019_mean <- colMeans(who_data_WSC_2019[7])
...
who_data_louv1_c1 <- who_data[who_data$region.stateili %in% louv1_c1,]
who_data_louv1_c1_2019 <- who_data_louv1_c1 %>% filter(between(datedec,2019.66,	2020.33))
louv1_c1_2019_mean <- colMeans(who_data_louv1_c1_2019[7])
...
who_data_louv1_c2 <- who_data[who_data$region.stateili %in% louv1_c2,]
who_data_louv1_c2_2019 <- who_data_louv1_c2 %>% filter(between(datedec,2019.66,	2020.33))
louv1_c2_2019_mean <- colMeans(who_data_louv1_c2_2019[7])
...
who_data_louv1_c3 <- who_data[who_data$region.stateili %in% louv1_c3,]
who_data_louv1_c3_2019 <- who_data_louv1_c3 %>% filter(between(datedec,2019.66,	2020.33))
louv1_c3_2019_mean <- colMeans(who_data_louv1_c3_2019[7])
...
who_data_louv2_c1 <- who_data[who_data$region.stateili %in% louv2_c1,]
who_data_louv2_c1_2019 <- who_data_louv2_c1 %>% filter(between(datedec,2019.66,	2020.33))
louv2_c1_2019_mean <- colMeans(who_data_louv2_c1_2019[7])
...
who_data_louv2_c2 <- who_data[who_data$region.stateili %in% louv2_c2,]
who_data_louv2_c2_2019 <- who_data_louv2_c2 %>% filter(between(datedec,2019.66,	2020.33))
louv2_c2_2019_mean <- colMeans(who_data_louv2_c2_2019[7])
...
who_data_louv2_c3 <- who_data[who_data$region.stateili %in% louv2_c3,]
who_data_louv2_c3_2019 <- who_data_louv2_c3 %>% filter(between(datedec,2019.66,	2020.33))
louv2_c3_2019_mean <- colMeans(who_data_louv2_c3_2019[7])
...
who_data_louv2_c4 <- who_data[who_data$region.stateili %in% louv2_c4,]
who_data_louv2_c4_2019 <- who_data_louv2_c4 %>% filter(between(datedec,2019.66,	2020.33))
louv2_c4_2019_mean <- colMeans(who_data_louv2_c4_2019[7])
...
who_data_louv2_c5 <- who_data[who_data$region.stateili %in% louv2_c5,]
who_data_louv2_c5_2019 <- who_data_louv2_c5 %>% filter(between(datedec,2019.66,	2020.33))
louv2_c5_2019_mean <- colMeans(who_data_louv2_c5_2019[7])
...
who_data_louv2_c6 <- who_data[who_data$region.stateili %in% louv2_c6,]
who_data_louv2_c6_2019 <- who_data_louv2_c6 %>% filter(between(datedec,2019.66,	2020.33))
louv2_c6_2019_mean <- colMeans(who_data_louv2_c6_2019[7])
...
who_data_louv2_c7 <- who_data[who_data$region.stateili %in% louv2_c7,]
who_data_louv2_c7_2019 <- who_data_louv2_c7 %>% filter(between(datedec,2019.66,	2020.33))
louv2_c7_2019_mean <- colMeans(who_data_louv2_c7_2019[7])
